...
% \newgeometry{top=2.5cm} % Commented out - geometry package not available
...
% \restoregeometry % Commented out - geometry package not available
% \fancyheadoffset{0pt} % Commented out - may cause issues without geometry
